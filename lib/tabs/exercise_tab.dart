...
class _ExerciseTabState extends State<ExerciseTab> {
                ...
                Container(
                  ...
                  child: showButton?FloatingActionButton.extended(
                    ...
                    onPressed: () {
                      ...
                      navigateToNotificationCreation();
                    },
                  ):SizedBox(),
                )
              ],
  ...
  Future<void> navigateToNotificationCreation() async {
    ...
    NotificationData notificationData = NotificationData(
        'Daily workout plan reminder @ ${selectedTime.hour>10?selectedTime.hour:"0${selectedTime.hour}"}:${selectedTime.minute>10?selectedTime.minute:"0${selectedTime.minute}"}',
        'Hi, it\'s time to do some sport. Head over to the Exercise section for a full description of your ',
